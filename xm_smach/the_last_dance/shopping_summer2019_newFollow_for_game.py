...
class Shopping():
    def __init__(self):
        ...
        self.trace = Concurrence(outcomes = ['remeber','stop','aborted'],
                                 ...
                                 input_keys = ['PT_LIST','mission','people_id'],
        ...
        with self.DealTask:
            ...
            StateMachine.add('SPEAK' , Speak() , transitions={'succeeded':'PLACE',
                                                             'aborted':'PLACE',
                                                             'error':'error'},
                                                    remapping={'sentence':'sentence1'})
        ...
        with self.shopping:
            ...
            self.shopping.userdata.rec = 1.0
            self.shopping.userdata.people_id = -1
            ...
            StateMachine.add('TRACE',
                                ...
                                remapping={'PT_LIST':'PT_LIST','mission':'mission1','people_id':'people_id'})
