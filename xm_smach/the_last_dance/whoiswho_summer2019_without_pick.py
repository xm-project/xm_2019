...
class WhoisWho():
    def __init__(self):
        ...
        self.waypoints=[]
        #'speaker': {'pos': Pose(Point( 1.630,-0.50, 0.000), Quaternion(0.000, 0.000, 0.033, 1)), 'mode': 1 },
        location= (Point(1.630, -0.50, 0.000),  #找人数的点
                   Point( 5.295, -1.189, 0.000),   #出门抓东西的点
                   Point( 0.000,0.000,0.000))     #结束出门的点
        quaternions=(Quaternion(0.000, 0.000, 0.033, 1),
