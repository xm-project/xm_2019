    ...
    def __init__(self):
        ...
        with self.grasp_from_list:
            ...
            StateMachine.add('GRASP',
                                self.sm_Pick,
                                transitions={'succeeded':'TURN','aborted':'TURN','error':'error'})
            StateMachine.add('TURN',
                                 TurnDegree(),
                                 transitions={'succeeded':'MOVE_PLACE','aborted':'MOVE_PLACE','error':'error'})
            ...
            StateMachine.add('PLACE',
                                ArmCmdPlace(),
                                transitions={'succeeded':'TURN2','aborted':'TURN2'},
            ...
            StateMachine.add('TURN2',
                                 TurnDegree(),
                                 transitions={'succeeded':'MOVE_PICK2','aborted':'MOVE_PICK2','error':'error'})
