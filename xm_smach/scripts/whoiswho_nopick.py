...
class WhoisWho():
    def __init__(self):
        ...
        location= (Point(1.739, 4.203, 0.000),  #找人数的点
                   Point( 6.470, 0.043, 0.000),   #出门抓东西的点
                   Point( 7.840,4.903,0.000))     #结束出门的点
        quaternions=(Quaternion(0.000, 0.000, 0.000, 1.000),
                     Quaternion(0.000, 0.000, 0.675, 0.738),
                     Quaternion(0.000,0.000,0.692, 0.722))
        ...
        with self.WHOISWHO:
            ...
            StateMachine.add('NAV_ROOM',
                                NavStack(),
                                remapping ={'pos_xm':'nav_ps'},
                                transitions ={'succeeded':'CHECKFINISH','aborted':'NAV_ROOM','error':'error'})
