...
#jacy:
def xm_gripper(pose_name):
   try:
       moveit_commander.roscpp_initialize(sys.argv)
       xm_gripper=moveit_commander.MoveGroupCommander('xm_gripper')
       xm_gripper.set_goal_joint_tolerance(0.01)
       xm_gripper.set_joint_value_target(pose_name)
       xm_gripper.go()
   except:
       return False
       rospy.sleep(1.0)
