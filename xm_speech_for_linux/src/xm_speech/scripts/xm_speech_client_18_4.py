...
sys.path.append('.')
msc = cdll.LoadLibrary("/home/domestic/catkin_ws/src/xm_speech_for_linux/xm_speech/lib/libmsc.so") # change   根据lib中libmsc.so文件的绝对路径来改变
...
Object ->"cola"|"milk"|"noodles"|"biscuit"|"chips"|"rollpaper"|"toothpaste"|"soap"|"water"|"coffee"|"cake"
...
class XM(Recognizer):
    def __init__(self):
        ...
        #####
        self.login_params = "appid = 5b45be24, work_dir = ." # change   需根据讯飞账号做修改
        ...
        if type(text) == str and len(text) != 0:
            ...
            if xm_speech_req.command == 1:#Answer a question
                ...
                if text == "How many bookshelf are in the living room":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Three')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Three"])
                elif text == "In which room is the fridge":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Kitchen')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Kitchen"])
                elif text == "How many doors has the Arena":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('2')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","2"])
                elif text == "In which room is the dining table":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('diningroom')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","diningroom"])
                elif text == "Where is located the bed":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('bedroom')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","bedroom"])
                elif text == "How many fireplace are in the bedroom":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('zero')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","zero"])
                elif text == "In which room is the sofa":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('livingroom')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","livingroom"])
                ...
                #ObjectQ
                    ...
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Shin junk')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Shin junk"])
                elif text == "how large is the area of china":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Nine million and six hundred thousand saquare kilometers')
                ...
                #PredefinedQ
                    ...
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('A little over 80 million')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","A little over 80 million"])
                elif text == "what is the capital of the united states":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Washington DC')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Washington DC"])
                elif text == "what day is today":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Saturday')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Saturday"])
                elif text == "What city is the capital of the Japan":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Tokyo')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Tokyo"])
                elif text == "Where does the term computer bug come from":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call("From a moth trapped in a relay")
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","From a moth trapped in a relay"])
                elif text == "When was invented the B programming language":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('B was developed circa 1969 at Bell Labs')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","B was developed circa 1969 at Bell Labs"])
                elif text == "Who invented the C programming language":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Ken Thompson and Dennis Ritchie')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Ken Thompson and Dennis Ritchie"])
                elif text == "What is the highest point in Japan":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('The highest point in Japan is Mount Fuji')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","The highest point in Japan is Mount Fuji"])
                elif text == "What are the colours of the Japanese flag":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Japanese flag is a red circle centred over white')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Japanese flag is a red circle centred over white"])
                elif text == "Who invented the first compiler":
                    xm_speech_res.num = 1
                    tts_test = rospy.ServiceProxy('tts',xm_Speech_tts)
                    tts_res = tts_test.call('Grace Brewster Murray Hopper invented it')
                    if tts_res.flag == 1:
                        subprocess.call(["play","tts_sample.wav"])
                    else:
                        subprocess.call(["espeak","-v","f3+en_us","-s","130","Grace Brewster Murray Hopper invented it"])
                ...
                if text == "you are right":
                    if len(text_last) != 0:
                        ...
                        if text_last.find("stop") >= 0:
                            ...
                            xm_speech_res.target.append('bedroom')
                        elif text_last.find("dinningroom") >= 0:
                            xm_speech_res.target.append('dinningroom')
                ...
                if text == "you are right":
                    if len(text_last) != 0:
                        ...
                        if text_last.find('paper') >= 0:
                            xm_speech_res.object.append('paper')
                            num += 1
                        if text_last.find('noodles') >= 0:
                            xm_speech_res.object.append('noodles')
                            num += 1
                        if text_last.find('pie') >= 0:
                            xm_speech_res.object.append('pie')
                            num += 1
                        if text_last.find('tea') >= 0:
                            xm_speech_res.object.append('tea')
                            num += 1
                        if text_last.find('biscuit') >= 0:
                            xm_speech_res.object.append('biscuit')
                            num += 1
                        if text_last.find('chip') >= 0:
                            xm_speech_res.object.append('chip')
                            num += 1
                        if text_last.find('soap') >= 0:
                            xm_speech_res.object.append('soap')
                            num += 1
                        if text_last.find('shampoo') >= 0:
                            xm_speech_res.object.append('shampoo')
                            num += 1
                        if text_last.find('milk tea') >= 0:
                            xm_speech_res.object.append('milk tea')
                            num += 1
                        if text_last.find('water') >= 0:
                            xm_speech_res.object.append('water')
                            num += 1
                        if text_last.find('toothpaste') >= 0:
                            xm_speech_res.object.append('toothpaste')
                            num += 1
                        if text_last.find('coffee') >= 0:
                            xm_speech_res.object.append('coffee')
                            num += 1
                        if text_last.find('cola') >= 0:
                            xm_speech_res.object.append('cola')
                            num += 1
                        if text_last.find('red bull') >= 0:
                            xm_speech_res.object.append('red bull')
                            num += 1 
    ...
    def listen(self, source, timeout=None, phrase_time_limit=None):
        ...
        while True:
            ...
            while True:
                ...
                buffer = source.stream.read(source.CHUNK)
                if len(buffer) == 0 or lenflag == 200: 
