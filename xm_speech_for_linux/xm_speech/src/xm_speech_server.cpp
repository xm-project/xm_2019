...
const char * GRM_FILE            = "msc/GPSR.bnf";         //构建离线识别语法网络所用的语法文件
...
bool run_asr(xm_msgs::xm_Speech::Request &req,xm_msgs::xm_Speech::Response &res)
{
...
{
    const char *login_config     = "appid = 5b45be24"; //登录参数
	int ret                      = 0 ;
	char c;
