...
#include "ros/ros.h"
#include "pthread.h"
#include "xm_speech/xm_speech_isr.h"
...
const char * ASR_RES_PATH        = "fo|/home/domistic/catkin_ws/src/xm_speech_for_linux/xm_speech/msc/res/asr/common.jet"; //离线语法识别资源路径
const char * GRM_BUILD_PATH      = "/home/domistic/catkin_ws/src/xm_speech_for_linux/xm_speech/msc/res/asr/shopping"; //构建离线语法识别网络生成数据保存路径
const char * GRM_FILE            = "/home/domistic/catkin_ws/src/xm_speech_for_linux/xm_speech/msc/bnf/shopping.bnf"; //构建离线识别语法网络所用的语法文件
...
const char *get_audio_file(string a); //选择进行离线语法识别的语音文件
...
int run_asr(UserData *udata,string a)
{
...
bool SpeechToText(xm_speech::xm_speech_isr::Request  &req, xm_speech::xm_speech_isr::Response  &res)
{
	const char *login_config    = "appid = 5d5e43d9";// 5c2c71ab 5b696e49/
	UserData asr_data; 
	int ret                     = 0 ;
	char c;
...
{
    ros::init(argc, argv, "isr_sample");
    ros::NodeHandle n;

    ros::ServiceServer service = n.advertiseService("isr",SpeechToText);
