...
int identify::get_person_location(int command_num, int search_id)
{
    ...
    if(command_num == 1)                    //if command_num == 1，take photos of five persn and store
    {
        ...
        cv::imwrite("/home/domestic/Vision/data/identify.jpg",frame);

        system("rm -rf /home/domestic/Vision/data/people_identify/");
        system("mkdir /home/domestic/Vision/data/people_identify/");
	system("rm -rf /home/domestic/Vision/data/people_identify_all/");
        system("mkdir /home/domestic/Vision/data/people_identify_all/");

        system("python /home/domestic/xm_vision/src/xm_vision/src/five_people.py");
        
        //读取五人二维坐标
        int top, right, bottom, left;
        std::ifstream people_rect("/home/domestic/Vision/data/people_identify/people_rect.txt");
        ...
        for(int i = 0; i < targetCor.size(); i++)
        {
            ...
            int_to_name = buf;
            std::string single_face_path = "/home/domestic/Vision/data/people_identify/" + int_to_name + ".jpg";          
            cv::imwrite(single_face_path, frame(people_position[i]));
        }
         std::cout<<"检测到　person 个数为 "<<targetCor.size()<<std::endl;

        // frame=cv::imread("/home/domestic/pic/4.jpg",1);
        // if(frame.empty())
        // {
        ...
        // cv::imwrite("/home/domestic/Vision/data/people_identify/dst.jpg",frame);
    ...
    else if(command_num == 2)
    {
        ...
        cv::imwrite("/home/domestic/Vision/data/people_identify/scene.jpg", frame);

        system("rm /home/domestic/Vision/data/people_identify/id.txt");
        system("rm /home/domestic/Vision/data/people_identify/message.txt");

        std::ofstream out("/home/domestic/Vision/data/people_identify/id.txt");
        if (out.is_open())   
        {  
            out << search_id;   
            out.close();  
	    ...
	    system("python /home/domestic/xm_vision/src/xm_vision/src/face.py");

        int top, right, bottom, left;
        std::ifstream in("/home/domestic/Vision/data/people_identify/message.txt");
        if (! in.is_open())  
        { 
            std::cout << "Error opening file"; 
            if_detected = 1;                //end the node
