...
# 读取图片并识别人脸
img = face_recognition.load_image_file("/home/wangyu/Vision/data/identify.jpg")
face_locations = face_recognition.face_locations(img)
print face_locations

# 调用opencv函数显示图片
img = cv2.imread("/home/wangyu/Vision/data/identify.jpg")
cv2.namedWindow("原图")
cv2.imshow("原图", img)
...
file_out = open('/home/wangyu/Vision/data/people_identify/people_rect.txt','w')
...
for i in range(0, faceNum):
    ...
    cv2.imwrite("/home/wangyu/Vision/data/people_identify_all/"+str(i)+".jpg",tmp)
