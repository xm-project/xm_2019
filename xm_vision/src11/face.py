...
def recognize(identifier):
    ...
    eg_face_image = face_recognition.load_image_file('/home/wangyu/Vision/data/people_identify/' + identifier + '.jpg')
    eg_face_encoding = face_recognition.face_encodings(eg_face_image)

    file_out = open('/home/wangyu/Vision/data/people_identify/message.txt','w')
    ...
    # Load scene
    scene = cv2.imread('/home/wangyu/Vision/data/people_identify/scene.jpg')
...
if __name__=="__main__":
    file_in = open('/home/wangyu/Vision/data/people_identify/id.txt','r')
    line = file_in.read()
    recognize(line[0])
