...

{
    ...
    // frame=cv::imread("/home/domestic/pic/1.jpg");
    // cv:: resize(frame,frame,cv::Size(800,600));  
    // cv::imshow("test",frame);
    int pic_num = 68;
   // system("sudo rm     /home/domestic/Vision/data/dataset/");
   // system("sudo mkdir  /home/domestic/Vision/data/dataset");
    while (1)
    {
        ...
        if(ch == 'c')
        {
            ...
            std::string name;
            name = buf;
            std::string path = "/home/domestic/Vision/data/picture2019/"+name+".jpg";
